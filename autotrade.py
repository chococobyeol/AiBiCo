...
def check_market_conditions():
    ...
    # 변동성 조건 확인
    volatility_condition_1 = ten_min_volatility > short_term_volatility * 3
    volatility_condition_2 = ten_min_volatility > current_volatility * 4

    # 거래량 조건 확인
    volume_condition_1 = ten_min_volume > (avg_volume_24h / 6) * 3
    volume_condition_2 = ten_min_volume > (avg_volume_14d / 144) * 4
    ...
    autotrade_logger.info(f"Volatility condition 1 (10-min > 24-hour * 3): {volatility_condition_1}")
    autotrade_logger.info(f"Volatility condition 2 (10-min > 14-day * 4): {volatility_condition_2}")
    autotrade_logger.info(f"Volume condition 1 (10-min > 24-hour/6 * 3): {volume_condition_1}")
    autotrade_logger.info(f"Volume condition 2 (10-min > 14-day/144 * 4): {volume_condition_2}")
